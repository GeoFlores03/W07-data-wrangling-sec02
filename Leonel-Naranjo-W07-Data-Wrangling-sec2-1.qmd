...
**Note**: This codebook is based on the content of the lecture notrs published on [Data Wrangling with tidyverse](https://jmjung.quarto.pub/m05-1-principles-data-wrangling-with-tidyverse-in-r)
...
::: callout-tip
To use mouse multi-cursor editing feature, do the following steps: 1. Select text you want to edit. 2. Press 'shift + alt + I' and click on the text you want to edit. 3. You can now edit all the selected text simultaneously.
:::
...
**Note**: To add a code chunk, you can use the keyboard shortcut `Ctrl + Alt + I` (Windows/Linux) or `Cmd + Option + I` (Mac) in RStudio. - In visual mode: 'Ctrl + Alt +I' ( Mac) in Rstudio - In Source modle 'Cmd + Shift + I' (Mac) in Rstudio
...
flights_df |>
  ...
  labs(
    x = "Months",
    y = "# of Flights", 
    title = "# of flights by Months in New York"
  ) +
    theme_bw()
```